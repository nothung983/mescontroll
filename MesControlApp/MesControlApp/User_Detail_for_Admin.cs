...
namespace MesControlApp
{
    ...
    {
        public User_Detail_for_Admin(string username, string email, string phone, string password, string role, Image userImage)
        {
            InitializeComponent();
            ...
            usr_phone_txt.Text = phone;
            usr_pass.Text = password;
            user_role_txt.Text = role;
